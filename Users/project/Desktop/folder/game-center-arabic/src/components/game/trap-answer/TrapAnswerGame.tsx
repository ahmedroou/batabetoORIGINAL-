        ...
        return (
            <Card className="w-full max-w-lg animate-pop-in relative">
                ...
                <CardHeader className="text-center pt-20">
                    ...
                    <CardDescription>
                        حان دور <PlayerAvatar avatarId={playerWhoseTurnItIs?.avatarId || ''} className="w-6 h-6 inline-block" temporaryTitle={playerWhoseTurnItIs?.temporaryTitle}/> <strong>{isMyTurn ? 'أنت' : playerWhoseTurnItIs?.name}</strong> لاختيار قسم.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
                        {cunningDeceiver && (
                            <div className="p-3 rounded-lg bg-red-100 border border-red-300">
                                ...
                                <PlayerAvatar avatarId={cunningDeceiver.avatarId} className="w-16 h-16 mx-auto my-2" temporaryTitle={cunningDeceiver.name}/>
                         ...
                         {deceivedFool && (
                            <div className="p-3 rounded-lg bg-blue-100 border border-blue-300">
                                ...
                                <PlayerAvatar avatarId={deceivedFool.avatarId} className="w-16 h-16 mx-auto my-2" temporaryTitle={deceivedFool.name}/>
