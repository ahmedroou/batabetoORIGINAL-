...
interface ExecutionAnimationOverlayProps {
    ...
    playerTemporaryTitle?: string;
    onAnimationEnd: () => void;
}

export const ExecutionAnimationOverlay = ({ playerName, playerAvatarId, playerTemporaryTitle, onAnimationEnd }: ExecutionAnimationOverlayProps) => {
    useEffect(() => {
        ...
        <AnimatePresence>
            ...
            >
                <div className="relative mb-4">
                    <PlayerAvatar avatarId={playerAvatarId} className="w-40 h-40 rounded-full border-4 border-destructive" temporaryTitle={playerTemporaryTitle} />
                    <motion.div
                        key="skull-icon"
