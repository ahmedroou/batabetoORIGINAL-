...
type LoadingState = "create-king-of-genius" | "create-trap-answer" | "create-behind-the-mask" | "create-word_war" | "create-draw-and-guess" | "create-prison" | "create-smart-merchant" | "join" | "league" | null;
...
const gameCards = [
    ...
    { type: 'smart-merchant', title: 'التاجر الذكي', description: 'اشترِ عقارات وجاوب على الأسئلة لتسيطر على اللوحة.' },
];
