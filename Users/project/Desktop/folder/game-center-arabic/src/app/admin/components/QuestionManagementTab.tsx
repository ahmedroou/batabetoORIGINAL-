...
export default function QuestionManagementTab() {
    ...
    const confirmDelete = async () => {
     ...
     const handleAddCategory = async () => {
        ...
        if (result.success) {
            ...
            fetchCategories(categoryManagementGame as 'trap-answer');
            setNewCategory("");
        } else {
    ...
    const renderManageCategories = () => (
        <div className="space-y-4">
            ...
            <>
                 <div>
                    <Label htmlFor="new-category-input">إضافة قسم جديد لـ "{categoryManagementGame === 'trap-answer' ? 'الجواب المفخخ' : ''}"</Label>
                 ...
                 <div className='border-t pt-4'>
                    <h4 className="font-bold mb-2">الأقسام الحالية</h4>
                     <div className="space-y-2">
                        {(categoryManagementGame === 'trap-answer' ? trapAnswerCategories : []).map(cat => (
