...
export type DeletionParams = { 
    game: 'word_war' | 'prison' | 'snakes_and_scissors'; 
    category?: string; 
    searchTerm?: string; 
...
export default function QuestionManagementTab() {
    ...
    const [selectedGame, setSelectedGame] = useState<Exclude<Game['gameType'], 'trap-answer' | 'behind-the-mask' | 'king-of-genius'> | ''>('');
            ...
            <AlertDialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction onClick={confirmDelete} className={buttonVariants({ variant: "destructive" })} disabled={isDeleting || isActionLoading}>
