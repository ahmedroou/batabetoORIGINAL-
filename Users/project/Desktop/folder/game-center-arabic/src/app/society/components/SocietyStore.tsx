...
import { exchangeForLoyaltyPoints, exchangeCoinsForHonor } from '@/lib/actions/user';
...
export default function SocietyStore() {
    ...
    const [isSubmitting, setIsSubmitting] = useState<'loyalty' | 'honor' | null>(null);
    ...
    const handleLoyaltyExchange = async () => {
        ...
        try {
            const result = await exchangeForLoyaltyPoints(userProfile.uid, amount, 'coins');
            if (result.success) {
            ...
            <Card className="w-full max-w-lg bg-gray-800/50 border-purple-500/30 text-white backdrop-blur-sm">
                <CardHeader className="text-center">
                    ...
                    <CardDescription className="text-gray-400">
                        استبدل عملاتك ونقاطك بنقاط الولاء والشرف لتعزيز علاقاتك وتحالفاتك.
                    </CardDescription>
                </CardHeader>
