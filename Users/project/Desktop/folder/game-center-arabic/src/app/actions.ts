...
import type { Game, Challenge, ChallengePrize, DrawingData, GuessStatus, SocialRank, AvatarPrice, UserProfile, NightAction } from '@/types';
...
export async function getAvatarPrices() { return adminActions.getAvatarPrices(); }
export async function getPunishmentAvatarPrices() { return adminActions.getPunishmentAvatarPrices(); }
export async function setAvatarPrices(adminId: string, prices: AvatarPrice[]) { return adminActions.setAvatarPrices(adminId, prices); }
export async function setPunishmentAvatarPrices(adminId: string, prices: AvatarPrice[]) { return adminActions.setPunishmentAvatarPrices(adminId, prices); }
export async function setDefaultAvatar(adminId: string, avatarId: string) { return adminActions.setDefaultAvatar(adminId, avatarId); }
export async function setSocialRanks(adminId: string, ranks: SocialRank[]) { return adminActions.setSocialRanks(adminId, ranks); }
export async function addPermissionToRank(adminId: string, rankName: string, permissionId: any) { return adminActions.addPermissionToRank(adminId, rankName, permissionId); }
export async function removePermissionFromRank(adminId: string, rankName: string, permissionId: any) { return adminActions.removePermissionFromRank(adminId, rankName, permissionId); }
export async function getAnnouncement() { return adminActions.getAnnouncement(); }
export async function setAnnouncement(adminId: string, text: string) { return adminActions.setAnnouncement(adminId, text); }
export async function recalculateGameKings(adminId: string) { return adminActions.recalculateGameKings(adminId); }
export async function adminUpdateUser(adminId: string, userId: string, data: Partial<UserProfile>) { return adminActions.adminUpdateUser(adminId, userId, data); }
export async function backfillPunishmentStatus(adminId: string) { return adminActions.backfillPunishmentStatus(adminId); }
export async function adminSendMail(adminId: string, recipientIds: string[], subject: string, body: string, coins: number) { return adminActions.adminSendMail(adminId, recipientIds, subject, body, coins); }
...
export async function randomizeTeams(gameId: string, hostId: string) { return wordWarActions.randomizeTeams(gameId, hostId); }
...
export async function setGuide(gameId: string, hostId: string, playerId: string) { return wordWarActions.setGuide(gameId, hostId, playerId); }
...
export async function submitNightAction(gameId: string, action: NightAction) { return behindTheMaskActions.submitNightAction(gameId, action); }
...
export async function submitRating(gameId: string, raterId: string, rating: number) { return drawAndGuessActions.submitRating(gameId, raterId, rating); }

// Smart Merchant Actions
export async function startSmartMerchantGame(gameId: string, hostId: string) { return smartMerchantActions.startGame(gameId, hostId); }
export async function updateSmartMerchantSettings(gameId: string, hostId: string, settings: any) { return smartMerchantActions.updateGameSettings(gameId, hostId, settings); }
export async function rollDiceAndMove(gameId: string, playerId: string) { return smartMerchantActions.rollDiceAndMove(gameId, playerId); }
export async function handleMoveEnd(gameId: string, playerId: string) { return smartMerchantActions.handleMoveEnd(gameId, playerId); }
export async function handleBuyDecision(gameId: string, playerId: string, decision: 'buy' | 'pass') { return smartMerchantActions.handleBuyDecision(gameId, playerId, decision); }
export async function answerQuestion(gameId: string, playerId: string, answer: string) { return smartMerchantActions.answerQuestion(gameId, playerId, answer); }
export async function endSmartMerchantTurn(gameId: string, playerId: string) { return smartMerchantActions.endTurn(gameId, playerId); }

// Snakes and Scissors Actions
export async function startSnakesAndScissorsGame(gameId: string, hostId: string) { return snakesAndScissorsActions.startGame(gameId, hostId); }
export async function updateSnakesAndScissorsSettings(gameId: string, hostId: string, settings: any) { return snakesAndScissorsActions.updateGameSettings(gameId, hostId, settings); }
