...
// --- Internal Logic from behind-the-mask.ts moved here for testing ---

function checkForWinnerInternal(players: Player[]): Game['gameResult'] | null {
...
async function processNightInternal(game: Game): Promise<{ updatedPlayers: Player[], newEvents: DayEvent[], newPrivateEvents: Record<string, PrivateEvent[]>, newPrivateChats: Record<string, PrivateChat>, newLastHealedPlayerId: string | null }> {
