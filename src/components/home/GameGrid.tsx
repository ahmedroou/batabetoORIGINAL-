              ...
              <Card className="relative h-full border-none bg-transparent shadow-none">
                <CardContent className="p-3">
                  <div className="flex items-center gap-3">
                    <div className="mx-auto grid h-16 w-16 place-items-center rounded-2xl border border-white/15 bg-gradient-to-b from-background/70 to-background/40 shadow-inner flex-shrink-0">
                    ...
                    <div className="flex-grow min-w-0">
                      <div className="flex items-center justify-between">
                         ...
                         {tag && (
                           <span className="select-none rounded-full border border-white/10 bg-background/70 px-2 py-0.5 text-xs font-semibold shadow-sm backdrop-blur inline-flex items-center gap-1">
                      ...
                      <CardDescription className="leading-relaxed text-xs truncate">
                       ...
                       <Popover>
                        <PopoverTrigger asChild>
                             <Button variant="link" size="sm" className="h-auto p-0 mt-1 inline-flex items-center gap-1 text-muted-foreground hover:text-primary">
                     ...
                     <Button
                        className="rounded-xl bg-gradient-to-r from-primary to-secondary text-primary-foreground shadow-lg transition-transform hover:opacity-90 focus-visible:translate-y-[1px] h-12"
