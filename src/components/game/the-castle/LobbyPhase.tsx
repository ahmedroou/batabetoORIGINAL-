...
export function LobbyPhase({ game, self, isHost }: LobbyPhaseProps) {
    ...
    const handleStartGame = async () => {
        ...
        setIsSubmitting(true);
        try {
            await castleActions.startTheCastleGame(game.id, self.id);
        } catch(e: any) {
        ...
        <>
            <Card className="w-full max-w-md animate-bounce-in">
                <CardHeader className="text-center">
                    ...
                    <CardDescription>ادعُ أصدقاءك. ستقوم اللعبة بتقسيمكم إلى فريقين بشكل عشوائي عند البدء.</CardDescription>
                </CardHeader>
