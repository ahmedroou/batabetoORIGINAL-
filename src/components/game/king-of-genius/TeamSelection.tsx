...
import { selectTeam, startGame } from '@/lib/actions/king-of-genius';
                ...
                {players.map(p => (
                    ...
                    >
                        ...
                        <div>
                            ...
                            {p.id === self.id && <p className="text-xs text-primary font-bold">(أنت)</p>}
                        </div>
                    </motion.div>
                ))}
                </AnimatePresence>
  ...
  return (
    <Card className="w-full max-w-4xl animate-pop-in bg-white/80 backdrop-blur-sm border-gray-200">
        <CardHeader className="text-center">
            ...
            <CardDescription>اختر فريقك. يمكن اللعب 1ضد1، 2ضد2، أو 3ضد3.</CardDescription>
        </CardHeader>
        <CardContent>
