...
export async function uploadDrawAndGuessPromptsFromJson(prompts: { text: string }[], category: string) {
...
export async function getDrawAndGuessCategories(): Promise<{success: boolean, categories?: string[], error?: string}> {
    try {
...
export async function addDrawAndGuessCategory(category: string): Promise<{success: boolean, error?: string}> {
    if (!category || typeof category !== 'string' || category.trim() === '') {
...
export async function editDrawAndGuessCategory(oldCategory: string, newCategory: string): Promise<{ success: boolean; error?: string }> {
...
export async function deleteDrawAndGuessCategory(categoryToDelete: string): Promise<{ success: boolean; count?: number; error?: string }> {
