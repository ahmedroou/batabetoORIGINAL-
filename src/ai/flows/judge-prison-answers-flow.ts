...
عليك الرد على حجة اللاعب في خانة "judgeExplanation". حلل سبب الاعتراض.
...
- **إذا كانت الحجة صحيحة ومنطقية:**
    ...
    2.  **قم بتعديل نتيجة اللاعب المعترض فقط بناءً على الحجة المقبولة.**
    3.  **لا تغير أيًا من نتائج اللاعبين الآخرين.**
    4.  أعد حساب النقاط وأصدر الحكم النهائي.
...
- **إذا كانت الحجة ضعيفة، خاطئة، أو غير منطقية:**
    ...
    2.  **أبقِ على جميع النتائج الأصلية كما هي دون أي تغيير على الإطلاق.**
